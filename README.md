...
<head>
    ...
    <title>ITD — Социальная сеть нового поколения</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-content">
            ...
            <div style="flex: 1; max-width: 400px; margin: 0 1rem;">
                <input type="text" id="searchInput" class="input" placeholder="Поиск..." oninput="handleSearch()">
            </div>

            <!-- НАВИГАЦИЯ -->
            <ul class="nav-links">
                <li><a href="#" class="nav-link active" onclick="showHome()"><span>🏠</span><span>Главная</span></a></li>
                <li><a href="#" class="nav-link" onclick="showFeed()"><span>📱</span><span>Лента</span></a></li>
                <li><a href="#" class="nav-link" onclick="showDiscover()"><span>🔍</span><span>Обзор</span></a></li>
                <li><a href="#" class="nav-link" onclick="showLive()"><span>🔥</span><span>Live</span></a></li>
                <li><a href="#" class="nav-link" onclick="showClans()"><span>🎭</span><span>Кланы</span></a></li>
    ...
    <div class="tab-bar">
        <ul class="nav-links">
            <li><a href="#" class="nav-link active" onclick="showHome()"><span>🏠</span></a></li>
            <li><a href="#" class="nav-link" onclick="showDiscover()"><span>🔍</span></a></li>
            ...
            <li><a href="#" class="nav-link" onclick="showLive()"><span>🔥</span></a></li>
            <li><a href="#" class="nav-link" onclick="showProfile()"><span>👤</span></a></li>
        </ul>
    </div>
    ...
    <div id="voiceRecorder" class="voice-recorder d-none">
        ...
        <button class="btn btn-danger btn-sm" onclick="stopVoiceRecording()">Отправить</button>
        <button class="btn btn-secondary btn-sm" onclick="cancelVoiceRecording()">Отмена</button>
    </div>
    ...
    <div id="createMenu" class="create-menu">
        <button class="create-option" onclick="showCreatePost()">
            ...
            <div>
                <div>Новый пост</div>
                <div class="text-sm text-tertiary">Текст, фото, видео</div>
            </div>
        </button>
        <button class="create-option" onclick="showRecordVideo()">
            ...
            <div>
                ...
                <div class="text-sm text-tertiary">Короткое видео</div>
            </div>
        </button>
        <button class="create-option" onclick="showUploadVideo()">
            ...
            <div>
                ...
                <div class="text-sm text-tertiary">Из галереи</div>
            </div>
        </button>
        <button class="create-option" onclick="showCreateStory()">
            ...
            <div>
                <div>Сторис</div>
                <div class="text-sm text-tertiary">24 часа</div>
            </div>
        </button>
        <button class="create-option" onclick="startVoiceRecording()">
            ...
            <div>
                <div>Голосовое</div>
                <div class="text-sm text-tertiary">Записать сообщение</div>
            </div>
        </button>
    </div>
        ...
        <div class="modal-content">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h2 class="text-gradient" id="registerTitle">Регистрация</h2>
                    <button onclick="closeModal('registerModal')" class="btn-icon">×</button>
                </div>

                <div id="registerStep1">
                    <div class="input-group">
                        <label class="input-label">Выберите эмодзи</label>
                    ...
                    <div class="input-group">
                        <label class="input-label">Имя для отображения</label>
                        <input type="text" id="displayName" class="input" placeholder="Ваше имя">
                    </div>

                    <div class="d-flex gap-2 mt-6">
                        <button class="btn btn-secondary flex-1" onclick="closeModal('registerModal')">Отмена</button>
                        <button class="btn flex-1" onclick="nextStep()">Далее</button>
                    </div>
                </div>
                ...
                <div id="registerStep2" class="d-none">
                    <div class="input-group">
                        ...
                        <input type="password" id="password" class="input" placeholder="Минимум 8 символов">
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-6">
                        <button class="btn btn-secondary flex-1" onclick="prevStep()">Назад</button>
                        <button class="btn flex-1" onclick="register()">Зарегистрироваться</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h2 class="text-gradient" id="loginTitle">Вход</h2>
                    <button onclick="closeModal('loginModal')" class="btn-icon">×</button>
                </div>

                <div class="input-group">
                    <label class="input-label">Имя пользователя или Email</label>
                    <input type="text" id="loginInput" class="input" placeholder="Введите логин">
                </div>
                ...
                <div class="d-flex justify-between items-center mb-6">
                    ...
                    <a href="#" style="color: var(--primary);" onclick="showForgotPassword()">Забыли пароль?</a>
                </div>

                <button class="btn w-full mb-3" onclick="login()">Войти</button>
                <button class="btn btn-outline w-full" onclick="showRegister()">Создать аккаунт</button>
            </div>
        </div>
    </div>
    ...
    <div id="createPostModal" class="modal">
        <div class="modal-content">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h2 class="text-gradient" id="createPostTitle">Новый пост</h2>
                    <button onclick="closeModal('createPostModal')" class="btn-icon">×</button>
                </div>

                <div class="input-group">
                    <textarea id="postContent" class="textarea" placeholder="Что у вас нового?" rows="4" oninput="updateCharCount()" maxlength="1000"></textarea>
                ...
                <div class="d-flex gap-2 mb-6">
                    <button class="btn btn-secondary" onclick="addImageToPost()">📷 Фото</button>
                    <button class="btn btn-secondary" onclick="addVideoToPost()">🎥 Видео</button>
                    <button class="btn btn-secondary" onclick="takeScreenshot()">📸 Скриншот</button>
                </div>

                <div class="d-flex gap-2">
                    <button class="btn btn-secondary flex-1" onclick="closeModal('createPostModal')">Отмена</button>
                    <button class="btn flex-1" onclick="createPost()">Опубликовать</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="createStoryModal" class="modal">
        <div class="modal-content">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h2 class="text-gradient">Новый сторис</h2>
                    <button onclick="closeModal('createStoryModal')" class="btn-icon">×</button>
                </div>

                <div class="input-group">
                    <label class="input-label">Загрузите фото или видео</label>
                    <div style="border: 2px dashed var(--border); border-radius: 1rem; padding: 3rem; text-align: center; cursor: pointer;" onclick="document.getElementById('storyFile').click()">
                        ...
                        <div>Перетащите или нажмите для загрузки</div>
                        <div class="text-sm text-tertiary mt-1">Фото или видео до 15 секунд</div>
                    </div>
                ...
                <div id="storyPreview" class="mb-4 d-none">
                    <div class="position-relative" style="border-radius: 1rem; overflow: hidden;">
                        ...
                        <button onclick="removeStoryPreview()" class="position-absolute" style="top: 0.5rem; right: 0.5rem; background: rgba(0,0,0,0.5); color: white; border: none; border-radius: 50%; width: 32px; height: 32px; cursor: pointer;">×</button>
                    </div>
                </div>

                <div class="input-group">
                    <label class="input-label">Добавить текст (опционально)</label>
                    <input type="text" id="storyText" class="input" placeholder="Текст для сторис" maxlength="50">
                </div>

                <div class="d-flex gap-2 mt-6">
                    <button class="btn btn-secondary flex-1" onclick="closeModal('createStoryModal')">Отмена</button>
                    <button class="btn flex-1" onclick="publishStory()" id="publishStoryBtn" disabled>Опубликовать</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div style="position: relative; height: 100vh;">
                ...
                <div style="position: absolute; top: 1rem; left: 1rem; right: 1rem; z-index: 2;">
                    <div class="d-flex justify-between items-center">
                        <button onclick="closeRecordModal()" class="btn-circle" style="background: rgba(0,0,0,0.5); color: white;">×</button>
                        ...
                        <button onclick="toggleCamera()" class="btn-circle" style="background: rgba(0,0,0,0.5); color: white;">🔄</button>
                    </div>
                </div>
                ...
                <div id="recordPreview" class="d-none" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: #000; z-index: 3;">
                    ...
                    <div style="position: absolute; bottom: 2rem; left: 0; right: 0; padding: 0 1rem;">
                        <div class="d-flex gap-2">
                            <button class="btn btn-secondary flex-1" onclick="retryRecording()">Перезаписать</button>
                            <button class="btn flex-1" onclick="saveRecordedVideo()">Сохранить</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="videoPlayerModal" class="modal">
        <div class="modal-content modal-full">
            <div style="position: relative; height: 100vh;">
                ...
                <button onclick="closeModal('videoPlayerModal')" class="position-absolute" style="top: 1rem; left: 1rem; background: rgba(0,0,0,0.5); color: white; border: none; border-radius: 50%; width: 40px; height: 40px; font-size: 1.5rem; cursor: pointer; z-index: 2;">×</button>

                <div class="video-sidebar">
                    <button class="action-button" onclick="toggleVideoLike()">
                        <div class="icon" id="likeIcon">🤍</div>
                ...
                <div class="video-content">
                    <div class="video-info">
                        <h3 id="videoModalTitle">Название видео</h3>
                        <p id="videoDescription"></p>
                        <div class="video-tags" id="videoTags"></div>
                    </div>

                    <div class="creator-info">
                        <div class="creator-avatar" id="videoAuthorAvatar">😊</div>
                        <div class="creator-details">
                            <div class="d-flex items-center">
                                <div class="creator-name" id="videoAuthorName">Автор</div>
                        ...
                        <button class="follow-btn" id="followBtn" onclick="toggleFollow()">Подписаться</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content modal-full">
            <div style="position: relative; height: 100vh; background: #000;">
                ...
                <div class="live-viewers">
                    👁️ <span id="liveViewersCount">0</span>
                </div>

                <div style="position: absolute; bottom: 2rem; left: 0; right: 0; padding: 0 1rem; z-index: 2;">
                    <div class="d-flex gap-2">
                        <input type="text" class="input flex-1" placeholder="Комментарий..." id="liveCommentInput">
                        <button class="btn" onclick="sendLiveComment()">Отпр</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="uploadVideoModal" class="modal">
        <div class="modal-content">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h2 class="text-gradient">Загрузить видео</h2>
                    <button onclick="closeModal('uploadVideoModal')" class="btn-icon">×</button>
                </div>

                <div class="input-group">
                    <label class="input-label">Выберите видео файл</label>
                    <div style="border: 2px dashed var(--border); border-radius: 1rem; padding: 2rem; text-align: center; cursor: pointer;" onclick="document.getElementById('videoFile').click()">
                        ...
                        <div class="text-sm text-tertiary mt-1">До 100 МБ, MP4, MOV, AVI</div>
                    </div>
                ...
                <div class="input-group">
                    <label class="input-label">Название видео</label>
                    <input type="text" id="uploadTitle" class="input" placeholder="Название видео">
                </div>

                <div class="input-group">
                    <label class="input-label">Описание</label>
                    <textarea id="uploadDescription" class="textarea" rows="3" placeholder="Описание видео"></textarea>
                </div>

                <div class="input-group">
                    <label class="input-label">Теги (через запятую)</label>
                    <input type="text" id="uploadTags" class="input" placeholder="веселье, жизнь, видео">
                </div>

                <label class="d-flex items-center gap-1 mb-6 cursor-pointer">
                    <input type="checkbox" id="uploadFirstTake">
                    <span>🎬 Это первый дубль</span>
                </label>
                ...
                <div class="d-flex gap-2">
                    <button class="btn btn-secondary flex-1" onclick="closeModal('uploadVideoModal')">Отмена</button>
                    <button class="btn flex-1" onclick="uploadVideo()" id="uploadBtn" disabled>Загрузить</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="commentsModal" class="modal">
        <div class="modal-content" style="height: 80vh;">
            <div class="p-6">
                <div class="d-flex justify-between items-center mb-4">
                    <h3>Комментарии</h3>
                    <button onclick="closeModal('commentsModal')" class="btn-icon">×</button>
                </div>

                <div id="commentsList" style="flex: 1; overflow-y: auto; max-height: calc(80vh - 180px);"></div>

                <div class="d-flex gap-2 mt-4">
                    <input type="text" class="input flex-1" placeholder="Добавить комментарий..." id="commentInput">
                    <button class="btn" onclick="addComment()">Отпр</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const TRANSLATIONS = {
            ru: {
                appName: "ITD — Социальная сеть",
                welcome: "Добро пожаловать в ITD",
                loading: "Загрузка...",
                error: "Ошибка",
                success: "Успешно",
                ...
                search: "Поиск пользователей, видео...",
                createPost: "Создать пост",
                recordVideo: "Записать видео",
                uploadVideo: "Загрузить видео",
                createStory: "Создать сторис",
                ...
                newPost: "Новый пост",
                postContent: "Что у вас нового?",
                postVisibility: "Видимость",
                ...
                videoTags: "Теги (через запятую)",
                firstTake: "🎬 Это первый дубль",
                recording: "● Запись",
                stopRecording: "■ Стоп",
                saveVideo: "Сохранить видео",
                chooseFile: "Выберите видео файл",
                upload: "Загрузить",

                storyText: "Текст для сторис",
                storyUpload: "Загрузите фото или видео",
                storyPublish: "Опубликовать сторис",

                joinClan: "Вступить в клан",
                clanMembers: "участников",
                clanRank: "Ранг",

                noPosts: "Пока нет постов",
                noVideos: "Пока нет видео",
                noStories: "Пока нет сторис",
            ...
            hy: {
                appName: "ITD — Սոցիալական ցանց",
                welcome: "Բարի գալուստ ITD",
                loading: "Բեռնվում է...",
                error: "Սխալ",
                success: "Հաջողված",
                ...
                search: "Որոնել օգտատերեր, տեսանյութեր...",
                createPost: "Ստեղծել գրառում",
                recordVideo: "Գրանցել տեսանյութ",
                uploadVideo: "Վերբեռնել տեսանյութ",
                createStory: "Ստեղծել պատմություն",
                recordVoice: "Ձայնային հաղորդագրություն",
                like: "Հավանել",
                comment: "Մեկնաբանել",
                share: "Կիսվել",
                save: "Պահպանել",
                ...
                newPost: "Նոր գրառում",
                postContent: "Ինչ նորություն կա?",
                postVisibility: "Տեսանելիություն",
                visibilityPublic: "🌍 Հանրային",
                visibilityFriends: "👥 Ընկերներ",
                visibilityClan: "🎭 Կլան",
                addPhoto: "📷 Նկար",
                addVideo: "🎥 Տեսանյութ",
                takeScreenshot: "📸 Էկրանի նկար",
                publish: "Հրապարակել",

                videoTitle: "Տեսանյութի անվանում",
                videoDescription: "Նկարագրություն",
                videoTags: "Նշումներ (ստորակետերով)",
                firstTake: "🎬 Սա իմ առաջին տարբերակն է",
                recording: "● Գրանցում",
                stopRecording: "■ Կանգ",
                saveVideo: "Պահպանել տեսանյութը",
                chooseFile: "Ընտրեք տեսանյութի ֆայլ",
                upload: "Վերբեռնել",

                storyText: "Տեքստ պատմության համար",
                storyUpload: "Վերբեռնել նկար կամ տեսանյութ",
                storyPublish: "Հրապարակել պատմությունը",

                joinClan: "Միանալ կլանին",
                clanMembers: "մասնակից",
                clanRank: "Դիրք",

                noPosts: "Դեռ գրառումներ չկան",
                noVideos: "Դեռ տեսանյութեր չկան",
                noStories: "Դեռ պատմություններ չկան",
                beFirst: "Լինեք առաջինը",

                trending: "Թրենդներում",
                forYou: "Ձեզ համար",
                followingTab: "Բաժանորդագրություններ",
                liveNow: "Այժմ կենդանի",

                fieldRequired: "Լրացրեք այս դաշտը",
                usernameTaken: "Օգտանունն արդեն զբաղված է",
                passwordMismatch: "Գաղտնաբառերը չեն համընկնում",
                invalidEmail: "Անվավեր էլ. փոստ",
                loginError: "Սխալ օգտանուն կամ գաղտնաբառ"
            },
            en: {
                appName: "ITD — Social Network",
                ...
                firstTake: "🎬 This is my first take",
                recording: "● Recording",
                stopRecording: "■ Stop",
        ...
        function nextStep() {
            if (!selectedEmoji) {
                showToast('Выберите эмодзи', 'error');
                return;
            }
        ...
        function showLogin() {
            if (currentUser) {
                showToast('Вы уже авторизованы', 'info');
                return;
            }
                ...
                <div class="feed-container" id="feedContainer">
                    <div class="feed-item">
                        <div style="background: var(--gradient); height: 100%; display: flex; align-items: center; justify-content: center; flex-direction: column; padding: 2rem; text-align: center;">
                            ...
                            <p class="mb-4" style="font-size: 1.25rem; opacity: 0.9;">Социальная сеть нового поколения</p>
        ...
        function showVerticalFeed() {
            ...
            if (videos.length === 0) {
                ...
                videos.forEach(video => {
                    const user = db.users.find(u => u.id === video.userId) || {displayName: 'Неизвестный', emoji: '😊', followers: []};
                            ...
                            <div class="video-content">
                                ...
                                <div class="creator-info">
                                    ...
                                    <div class="creator-details">
                                        ...
                                        <div class="creator-stats">
                                            ${video.views || 0} просмотров • ${new Date(video.createdAt).toLocaleDateString()}
                                        </div>
                                    </div>
        ...
        function showFeed() {
            ...
            if (posts.length === 0) {
                ...
                posts.forEach(post => {
                    const user = db.users.find(u => u.id === post.userId) || {displayName: 'Неизвестный', emoji: '😊'};
                ...
                storiesHtml = `
                    <div class="stories-container">
                        ${uniqueStories.map(story => {
                            const user = db.users.find(u => u.id === story.userId) || {displayName: 'User', emoji: '😊'};
                ...
                trendingHtml = `
                    <div class="trending-container">
                        ...
                        ${trendingVideos.map((video, index) => {
                            const user = db.users.find(u => u.id === video.userId) || {displayName: 'User', emoji: '😊'};
                            return `
                                <div class="trending-item" onclick="playVideo('${video.id}')">
                                    <div class="trending-rank">${index + 1}</div>
                                    <div class="trending-content">
                                        <h4>${video.title}</h4>
                                        <p>${user.displayName} • ${video.views || 0} просмотров</p>
                                    </div>
                                </div>
                            `;
                        }).join('')}
            ...
            if (activeLive.length > 0) {
                liveHtml = `
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1rem;">
                        ${activeLive.map(stream => {
                            const user = db.users.find(u => u.id === stream.userId) || {displayName: 'Streamer', emoji: '🎮'};
                            return `
                                <div class="card" onclick="joinLiveStream('${stream.id}')" style="cursor: pointer; position: relative;">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex items-center gap-2 text-sm text-tertiary">
                                            ...
                                            <span>💬 ${stream.comments?.length || 0}</span>
                                        </div>
                                    </div>
                                </div>
                            `;
                ...
                liveHtml = `
                    <div class="empty-state">
                        <div class="empty-state-icon">🔴</div>
                        <h3>${t('liveNow')}</h3>
                        <p>Прямых эфиров пока нет</p>
                        ${currentUser ? `
                            <button class="btn" onclick="startLiveStream()">Начать эфир</button>
                        ` : `
        ...
        function startLiveStream() {
            ...
            const title = prompt('Введите название эфира:');
            if (!title) return;
        ...
        function joinLiveStream(streamId) {
            ...
            // Показываем модальное окно с эфиром
            document.getElementById('liveStreamContainer').innerHTML = `
                <div style="height: 100%; display: flex; align-items: center; justify-content: center; flex-direction: column; color: white; text-align: center;">
                    ...
                    <p>Прямой эфир • ${stream.viewers} зрителей</p>
                </div>
            `;
        ...
        function publishStory() {
            ...
            if (!fileInput.files[0]) {
                showToast('Загрузите фото или видео', 'error');
                return;
            }
            ...
            reader.onload = (e) => {
                ...
                showToast('Сторис опубликован!', 'success');
                showDiscover();
            };
        ...
        function startVoiceRecording() {
            ...
            // Здесь должна быть реальная запись через MediaRecorder API
            // Для демо просто показываем рекордер
        }
        ...
        function stopVoiceRecording() {
            ...
            const voiceMessage = {
                ...
                url: '#', // В реальном приложении здесь будет URL аудио
                createdAt: new Date().toISOString()
            };
            ...
            db.comments.push({
                ...voiceMessage,
                type: 'voice',
                postId: 'current_post' // В реальном приложении нужно указывать пост
            });
        ...
        async function startCamera() {
            try {
                ...
                showToast('Ошибка доступа к камере: ' + error.message, 'error');
            }
        }
        ...
        function saveRecordedVideo() {
            if (!window.recordedVideoUrl) {
                showToast('Сначала запишите видео', 'error');
                return;
            }

            const title = prompt('Введите название видео:', 'Мое видео');
            if (!title) return;
        ...
        function uploadVideo() {
            const file = document.getElementById('videoFile').files[0];
            const title = document.getElementById('uploadTitle').value.trim() || 'Мое видео';
        ...
        function playVideo(videoId) {
            ...
            // Проверяем подписку
            const following = currentUser && user.followers && user.followers.includes(currentUser.id);
            document.getElementById('followBtn').textContent = following ? 'Вы подписаны' : 'Подписаться';
        ...
        function toggleSaveVideo(videoId, button) {
            ...
            if (index > -1) {
                ...
                showToast('Удалено из сохраненных', 'info');
            } else {
                ...
                showToast('Добавлено в сохраненные', 'success');
            }
        ...
        function loadComments() {
            ...
            if (comments.length === 0) {
                list.innerHTML = '<div class="empty-state"><div>💬</div><p>Пока нет комментариев</p></div>';
                return;
            }

            let commentsHtml = '';
            comments.forEach(comment => {
                const user = db.users.find(u => u.id === comment.userId) || {displayName: 'Неизвестный', emoji: '😊'};

                if (comment.type === 'voice') {
                    commentsHtml += `
                        <div class="voice-message">
                            <button class="voice-play-btn" onclick="playVoice('${comment.id}')">▶️</button>
        ...
        function playVoice(commentId) {
            ...
            showToast('Воспроизведение голосового сообщения', 'info');
        }
        ...
        function takeScreenshot() {
            // В реальном приложении используйте html2canvas
            showToast('Функция скриншота в разработке', 'info');
        }
            ...
            postMedia.forEach((media, index) => {
                ...
                if (media.type === 'image') {
                    mediaEl.innerHTML = `
                        ...
                        <button onclick="removeMedia(${index})" class="position-absolute" style="top: 0.5rem; right: 0.5rem; background: rgba(239,68,68,0.9); color: white; border: none; border-radius: 50%; width: 32px; height: 32px; cursor: pointer;">×</button>
                    `;
                } else if (media.type === 'video') {
                    mediaEl.innerHTML = `
                    ...
                    <div class="card">
                        <div class="p-4 text-center">
                            ...
                            <button class="btn ${userInClan ? '' : 'btn-outline'}"
                                ...
                                ${userInClan ? 'Вы в клане' : t('joinClan')}
                            </button>
                        </div>
                    </div>
                `;
            ...
            document.getElementById('contentArea').innerHTML = `
                <div class="container" style="padding-top: 2rem;">
                    <div class="mb-4">
                        ...
                        <p class="text-secondary">Присоединяйтесь к сообществам по интересам</p>
                    </div>
        ...
        function joinClan(clanId) {
            ...
            showClans();
            showToast('Вы присоединились к клану!', 'success');
        }
                        ...
                        <div style="padding: 2rem; margin-top: -50px;">
                            <div class="d-flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    ${currentUser.isVerified ? '<span class="badge verified-badge mt-1">✓ Проверен</span>' : ''}
                                    ${currentUser.clan ? `<div class="badge badge-primary mt-1">Клан ${currentUser.clan}</div>` : ''}
                                </div>
                                <button class="btn btn-outline ml-auto" onclick="editProfile()">Редактировать</button>
                            </div>
                            ...
                            <div class="d-flex gap-4 mb-4">
                                <div style="text-align: center;">
                                    ...
                                    <div class="text-secondary">Посты</div>
                                </div>
                                <div style="text-align: center;">
                                    <div class="fw-bold text-xl">${currentUser.stats.videos}</div>
                                    <div class="text-secondary">Видео</div>
                                </div>
                                <div style="text-align: center;">
                                    <div class="fw-bold text-xl">${currentUser.stats.stories}</div>
                                    <div class="text-secondary">Сторис</div>
                                </div>
                                <div style="text-align: center;">
                                    <div class="fw-bold text-xl">${currentUser.followers?.length || 0}</div>
                                    <div class="text-secondary">Подписчики</div>
                                </div>
                            </div>

                            <div class="d-flex gap-2">
                                <button class="btn" onclick="showCreatePost()">Новый пост</button>
                                <button class="btn btn-outline" onclick="showMyVideos()">Мои видео</button>
                                <button class="btn btn-outline" onclick="showMyStories()">Мои сторис</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function showMyVideos() {
            ...
            if (videos.length === 0) {
                videosHtml = '<div class="empty-state"><div>🎥</div><p>У вас пока нет видео</p></div>';
            } else {
                videosHtml = `
            ...
            document.getElementById('contentArea').innerHTML = `
                <div class="container" style="padding-top: 2rem;">
                    <div class="d-flex justify-between items-center mb-4">
                        <h2 class="text-gradient">Мои видео</h2>
                        <button class="btn" onclick="showRecordVideo()">Записать видео</button>
                    </div>
                    ${videosHtml}
                </div>
            `;
        ...
        function showMyStories() {
            ...
            if (myStories.length === 0) {
                storiesHtml = '<div class="empty-state"><div>📸</div><p>У вас пока нет сторис</p></div>';
            } else {
                storiesHtml = `
                        ...
                        ${myStories.map(story => `
                            <div class="card" onclick="viewStory('${story.id}')" style="cursor: pointer;">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="text-sm">${story.seen?.length || 0} просмотров</div>
                                </div>
                            </div>
                        `).join('')}
                    </div>
            ...
            document.getElementById('contentArea').innerHTML = `
                <div class="container" style="padding-top: 2rem;">
                    <div class="d-flex justify-between items-center mb-4">
                        <h2 class="text-gradient">Мои сторис</h2>
                        <button class="btn" onclick="showCreateStory()">Новый сторис</button>
                    </div>
                    ${storiesHtml}
                </div>
            `;
        ...
        function handleSearch() {
            ...
            if (users.length > 0 || videos.length > 0) {
                showToast(`Найдено: ${users.length} пользователей, ${videos.length} видео`, 'info');
            }
        }
        ...
        function updatePageContent() {
            if (document.getElementById('contentArea').innerHTML.includes('feed-container')) {
                showHome();
            } else if (document.getElementById('contentArea').innerHTML.includes('Главная')) {
                showHome();
            } else if (document.getElementById('contentArea').innerHTML.includes('Лента')) {
                showFeed();
            } else if (document.getElementById('contentArea').innerHTML.includes('Обзор')) {
                showDiscover();
            } else if (document.getElementById('contentArea').innerHTML.includes('Live')) {
                showLive();
            } else if (document.getElementById('contentArea').innerHTML.includes('Кланы')) {
                showClans();
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Инициализируем кланы если нужно
            ...
            // Обработка свайпов для вертикальной ленты
            let startY = 0;
                ...
                if (e.target.closest('.feed-container') && !isScrolling) {
                    ...
                    if (Math.abs(diff) > 50) {
                        ...
                        if (diff > 0 && currentIndex < items.length - 1) {
                            // Свайп вверх - следующий элемент
                            items[currentIndex + 1].scrollIntoView({ behavior: 'smooth' });
                        } else if (diff < 0 && currentIndex > 0) {
                            // Свайп вниз - предыдущий элемент
                            items[currentIndex - 1].scrollIntoView({ behavior: 'smooth' });
                        }
            ...
            // Автовоспроизведение видео при скролле
        ...
        window.editProfile = () => showToast('Редактирование профиля в разработке', 'info');
        window.showForgotPassword = () => showToast('Восстановление пароля в разработке', 'info');
        window.shareVideo = () => showToast('Поделиться видео в разработке', 'info');
        window.sharePost = () => showToast('Поделиться постом в разработке', 'info');
        window.showPostComments = () => showToast('Комментарии к посту в разработке', 'info');
    </script>
</body>
</html>
